...
def render_modern_header():
    """Render the modern header section"""
    st.markdown(f"""
    <div class="modern-header fade-in-up">
        <div class="header-content">
            <h1 class="header-title">
                {ICONS["forge"]} ReconForge
            </h1>
            <p class="header-subtitle">
                Advanced Enterprise Asset Discovery & Intelligence Platform
            </p>
            <div class="header-badge">
                {ICONS["shield"]} Secure • {ICONS["intelligence"]} Intelligent • {ICONS["analytics"]} Comprehensive
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
def render_modern_sidebar():
    """Render the modern sidebar with enhanced navigation"""
    with st.sidebar:
...
def render_metrics_dashboard(result: ReconnaissanceResult):
    ...
    with col1:
        ...
        <div class="metric-card">
            <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">{ICONS['asn']}</div>
